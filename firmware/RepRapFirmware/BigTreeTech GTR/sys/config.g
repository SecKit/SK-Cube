; Configuration file for BigTreeTech GTR
...
M203 X21000.00 Y21000.00 Z420.00 E10000.00              ; set maximum speeds (mm/min)
...
; Axis Limits
M208 X0:220 Y0:196 Z-5:200                              ; set axis limits
...
G31 P500 X0 Y35 Z1.5                                    ; set Z probe trigger value, offset and trigger height
M557 X5:195 Y5:170 S38:33                               ; define mesh grid
...
M141 H2
M143 H2 S75                                             ; set temperature limit for heater 2 to 75C
...
M950 F2 C"fan2" Q700                                    ; create fan 1 on pin fan1 and set its frequency
